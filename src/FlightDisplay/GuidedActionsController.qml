...
Item {
    ...
    readonly property string rtlTitle:                      qsTr("Retornar para Local")
    readonly property string takeoffTitle:                  qsTr("Iniciar Decolagem")
    readonly property string landTitle:                     qsTr("Land")
    readonly property string startMissionTitle:             qsTr("Iniciar Missão")
    ...
    readonly property string setWaypointTitle:              qsTr("Definir ponto de referência")
    readonly property string gotoTitle:                     qsTr("Vá para o local")
    ...
    readonly property string takeoffMessage:                    qsTr("Decolagem do solo e manutenção da posição.")
    readonly property string startMissionMessage:               qsTr("Decole do solo e inicie a missão atual.")
    ...
    readonly property string rtlMessage:                        qsTr("Retorne à posição de lançamento do veículo.")
    readonly property string changeAltMessage:                  qsTr("Change the altitude of the vehicle up or down.")
    readonly property string gotoMessage:                       qsTr("Mova o veículo para o local especificado.")
             property string setWaypointMessage:                qsTr("Ajustar o ponto de passagem atual para %1 .").arg(_actionData)
