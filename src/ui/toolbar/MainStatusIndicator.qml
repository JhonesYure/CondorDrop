...
RowLayout {
    ...
    QGCLabel {
        id:             mainStatusLabel
        text:           mainStatusText()
        font.pointSize: 20//_vehicleInAir ? ScreenTools.defaultFontPointSize : ScreenTools.largeFontPointSize

        property string _commLostText:      qsTr("Comunicação Perdida")
        property string _readyToFlyText:    qsTr("Pronto para voo")
        property string _notReadyToFlyText: qsTr("Preparando")
        property string _disconnectedText:  qsTr("Desconectado")
        property string _armedText:         qsTr("Veículo Armado")
    ...
    FlightModeMenu {
        ...
        font.pointSize:         15//_vehicleInAir ?  ScreenTools.largeFontPointSize : ScreenTools.defaultFontPointSize
    ...
    QGCLabel {
        ...
        visible:                activeVehicle ? activeVehicle.vtol && _vehicleInAir : false
