...
Download the gstreamer from here: [gstreamer-1.0-android-universal-1.18.6.tar.bz2](https://gstreamer.freedesktop.org/data/pkg/android/1.18.6/gstreamer-1.0-android-universal-1.18.6.tar.xz)
